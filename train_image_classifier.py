...
tf.app.flags.DEFINE_string(
    'dataset_name', 'mydata', 'The name of the dataset to load.')

tf.app.flags.DEFINE_string(
    'dataset_split_name', 'train', 'The name of the train/test split.')

tf.app.flags.DEFINE_string(
    'dataset_dir', './tmp/data/mydata', 'The directory where the dataset files are stored.')
...
tf.app.flags.DEFINE_string(
    'checkpoint_path', './tmp/data/checkpoint/inception_v4.ckpt',
